...
import { authUser, loginUser, logoutUser, refreshAccessToken, registerPro, registerUser,getUser, googleLogin } from "../controllers/user.controller.js"
...
router.route("/google").post(googleLogin)   //login
