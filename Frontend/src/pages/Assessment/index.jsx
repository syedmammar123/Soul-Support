...
const Assessments = () => {
  ...
  return (
    <div>
      ...
      <div className="p-4 flex flex-col items-center justify-center">
        <h1 className="text-6xl m-10">Take a free mental health test</h1>
        <p className="text-center w-[42%] m-4">Our short online mental health screening tests will help you determine if you should seek help from a licensed mental health professional to address mental health issues.</p>
      </div>
      <div className="w-[90%] flex justify-between m-auto my-4 px-4">
        {loading ? (
          <>
